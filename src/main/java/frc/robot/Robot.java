...
public class Robot extends TimedRobot {
  ...
  // private DriveSubsystem m_DriveSubsystem; added by people
  ...
  public void autonomousInit() {
    m_moveCommand = m_robotContainer.getAutonomousCommand();
    //m_intakeCommand = m_robotContainer.intakeCommand();
